...
public:
	...
	static boost::shared_ptr<file_sink> get_initsink()
	{
		if (initsink_ == nullptr)
		{
			initsink_ = initlog();
	...
	static boost::shared_ptr< file_sink > initlog()
	{
		try
		{
	...
	static src::severity_logger< severity_level > get_slg()
	{
		return slg_;
	}
...
private:
	static boost::shared_ptr< file_sink > initsink_;
...
src::severity_logger< severity_level > singleton_boost_log::slg_;
